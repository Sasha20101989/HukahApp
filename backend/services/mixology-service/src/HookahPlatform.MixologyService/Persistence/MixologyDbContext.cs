...
public sealed class MixologyDbContext(DbContextOptions<MixologyDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<MixItemEntity>(entity => { entity.ToTable("mix_items"); entity.HasKey(item => item.Id); entity.Property(item => item.MixId).HasColumnName("mix_id"); entity.Property(item => item.TobaccoId).HasColumnName("tobacco_id"); });
    }
}
...
public sealed class MixEntity { public Guid Id { get; set; } public string Name { get; set; } = string.Empty; public string? Description { get; set; } public Guid BowlId { get; set; } public string Strength { get; set; } = string.Empty; public string TasteProfile { get; set; } = string.Empty; public decimal TotalGrams { get; set; } public decimal Price { get; set; } public decimal Cost { get; set; } public decimal Margin { get; set; } public bool IsPublic { get; set; } public bool IsActive { get; set; } public Guid? CreatedBy { get; set; } public DateTimeOffset CreatedAt { get; set; } }
public sealed class MixItemEntity { public Guid Id { get; set; } public Guid MixId { get; set; } public Guid TobaccoId { get; set; } public decimal Percent { get; set; } public decimal Grams { get; set; } }
