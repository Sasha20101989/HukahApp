  ...
  return (
    <main className="shell">
      <aside className="sidebar">
        ...
        <nav className="nav" aria-label="Admin sections"><a className="admin-link" href="/"><Flame size={18} />CRM</a><a className="admin-link" href="/admin/tenants"><Building2 size={18} />Тенанты</a><a className="admin-link" href="/admin/roles">Роли</a><a className="admin-link" href="/admin/audit">Audit</a></nav>
      </aside>
